    ...
    public static void main(String[] args) throws IOException {
        ...
        while(true) {
            ...
            if (hasJoinedHost){
                ...
                System.out.println(jeoparty.getMessage());  //any message sent, is received here
            ...
            //> if this client has not joined
                ...
                if(userInput.equals("start")) {
                    ...
                    jeoparty.joinServer(hostInput, Integer.parseInt(portInput));    //joins server, using jeoparty
